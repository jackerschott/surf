...
static char *fulluseragent = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.128 Safari/537.36"; /* Or override the whole user agent string */
...
#define HOMEPAGE "https://ecosia.org/"
